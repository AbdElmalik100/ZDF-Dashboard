...
import { Plus, Trash2, RefreshCw, ImageUp, Trash, Pencil } from 'lucide-react'
    ...
    useEffect(() => {
        return () => {
            ...
            setEvent({
                ...event,
                image: eventData.image,
                date: new Date(eventData.date).toLocaleDateString("en-CA")
            })
        }
    }, [openDialog])
    return (
                    ...
                    <div className="grid grid-cols-2 gap-4 py-4 px-1">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <label>
                                ...
                                <input type="date" name="date" className="p-1 px-3 rounded-md border w-full" value={event.date} onChange={handleChange} />
                            </label>
