...
export const getSubscriptions = createAsyncThunk("subscriptionsSlice/getSubscriptions", async ({eventId = "", workshopId = "", bundleId = ""}) => {
    try {
        const response = await axios.get(`api/subscriptions?event=${eventId}&workshop=${workshopId}&bundle=${bundleId}`)        
